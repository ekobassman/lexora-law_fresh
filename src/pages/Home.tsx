...
export function Home() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* CHAT DEMO SECTION */}
      <section id="chat-demo" className="bg-[#1e293b] py-10 md:py-16 px-2 sm:px-4 scroll-mt-20 min-h-[85vh] flex flex-col justify-center overflow-x-hidden pb-[max(2.5rem,env(safe-area-inset-bottom))] touch-pan-y">
        <div className="max-w-3xl mx-auto w-full min-w-0 px-0 sm:px-0">
          <ChatDemo />
        </div>
      </section>
